                ...
                <container class="expo-card container-companies-create">
                    <div class="div-companies-create">
                        ...
                        <div class="checkbox-card">
                            ...
                            <div for="patrocinador" class="checkbox-label">
        ...
        <section class="section-companies-list">
            <div class="carousel-wrapper">
                ...
                <div class="container-carrusel">
                    ...
                    <x-admin.company-card image="{{asset('assets/guest/sponsor(1).svg')}}" name="Epic Games" tier="Titanium" />
                    <x-admin.company-card image="{{asset('assets/guest/sponsor(2).svg')}}" name="Coca Cola" tier="Gold" />
                    <x-admin.company-card image="{{asset('assets/guest/sponsor(3).svg')}}" name="Accenture" tier="Bronze" />
